    ...
    def send_purchase_confirmation_email(
        ...
        try:
            ...
            if has_el_mercado and not has_merchandise:
                ...
                subject = f"🛍️ Order Confirmed - El Mercado | {settings.BRAND_SITE_LABEL}"
            elif has_merchandise and not has_el_mercado:
                purchase_type = 'merchandise_only'
                subject = f"🎉 Purchase Confirmed - {settings.BRAND_SITE_LABEL} Merchandise"
            else:
                purchase_type = 'mixed'
                subject = f"🎉 Your Purchase Confirmation - {settings.BRAND_SITE_LABEL}"
